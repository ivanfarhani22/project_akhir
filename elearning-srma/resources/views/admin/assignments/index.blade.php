...
<div class="max-w-7xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        ...
        <a href="{{ route('admin.assignments.create') }}" class="inline-flex items-center justify-center gap-2 px-3 sm:px-6 py-2 sm:py-3 bg-red-500 text-white rounded-lg font-semibold text-xs sm:text-sm hover:bg-red-600 transition whitespace-nowrap">
    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-6 mb-8">
        <form action="{{ route('admin.assignments.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-end">
                        ...
                        @forelse($assignments as $assignment)
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                ...
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="font-semibold text-gray-900 truncate">{{ $assignment->title }}</div>
                                    <div class="text-xs text-gray-600 hidden sm:block">{{ Str::limit($assignment->description, 50) }}</div>
                                </td>
                                ...
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="flex gap-1 sm:gap-2 flex-col sm:flex-row">
                                        ...
                                        <form action="{{ route('admin.assignments.destroy', $assignment) }}" 
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" onclick="confirmDelete(event, '{{ $assignment->title }}')" class="w-full sm:w-auto inline-flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-red-100 text-red-700 rounded hover:bg-red-200 transition text-xs font-semibold whitespace-nowrap" 
                                                title="Hapus">
