...
@section('content')
    <!-- Header -->
    <div class="mb-8">
        <p class="text-gray-500 text-sm mb-2">Edit Data</p>
        <h1 class="text-2xl font-bold text-gray-900 flex items-center gap-3">
            <i class="fas fa-user-edit text-red-500"></i>
            Edit Pengguna
        </h1>
        <p class="text-gray-500 text-sm mt-2">{{ $user->name }}</p>
    </div>

    <div class="max-w-2xl">
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-bold text-gray-900">Formulir Edit Pengguna</h2>
            </div>
            <div class="p-6">
