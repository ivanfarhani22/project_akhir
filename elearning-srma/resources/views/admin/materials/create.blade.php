...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-black text-gray-800 mb-2">Tambah Materi Pembelajaran</h1>
        <p class="text-gray-600">Unggah materi pembelajaran baru ke sistem</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-red-500 to-red-600 px-6 py-4">
            <h2 class="text-xl font-bold text-white flex items-center gap-2">
                <i class="fas fa-file-upload"></i>Form Tambah Materi
            </h2>
        </div>
        ...
        <div class="p-6 sm:p-8">
            <form action="{{ route('admin.materials.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="e_class_id" id="e_class_id" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-red-600 focus:outline-none @error('e_class_id') border-red-500 @enderror" required>
