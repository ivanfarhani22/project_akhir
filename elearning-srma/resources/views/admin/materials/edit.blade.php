...
<div class="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-2xl sm:text-3xl font-black text-gray-800 mb-2">Edit Materi Pembelajaran</h1>
        <p class="text-gray-600 text-xs sm:text-sm">Perbarui informasi materi pembelajaran</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-red-500 to-red-600 px-3 sm:px-6 py-3 sm:py-4">
            <h2 class="text-base sm:text-xl font-bold text-white flex items-center gap-2">
                <i class="fas fa-edit"></i><span class="hidden sm:inline">Form Edit Materi</span><span class="sm:hidden">Edit Materi</span>
            </h2>
        </div>
        ...
        <div class="p-3 sm:p-6 sm:p-8">
            <form action="{{ route('admin.materials.update', $material) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" class="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed text-xs sm:text-sm" 
                ...
                <div>
                    ...
                    @if($material->file_path)
                        <div class="mb-4 p-3 sm:p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
                            <p class="text-xs sm:text-sm text-blue-700 font-semibold mb-2">
                                <i class="fas fa-file-download mr-2"></i>File saat ini:
                            </p>
                            <a href="{{ route('admin.materials.download', $material) }}" target="_blank" class="text-blue-600 hover:text-blue-800 underline font-semibold text-xs sm:text-sm break-all">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold px-3 sm:px-6 py-2 sm:py-3 rounded-lg text-xs sm:text-sm hover:from-red-700 hover:to-red-800 transition flex items-center justify-center gap-2">
                        <i class="fas fa-save"></i> <span class="hidden sm:inline">Update Materi</span><span class="sm:hidden">Update</span>
                    </button>
