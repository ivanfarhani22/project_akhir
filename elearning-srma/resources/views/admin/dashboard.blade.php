...
@section('content')
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-red-500">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900">{{ \App\Models\User::where('role', 'siswa')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900">{{ \App\Models\User::where('role', 'guru')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-500">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900">{{ \App\Models\EClass::count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-amber-500">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900">{{ \App\Models\Material::count() }}</p>
                </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
            <!-- Tambah Pengguna -->
            <a href="{{ route('admin.users.create') }}" class="bg-white rounded-lg shadow-sm hover:shadow-md transition p-4 sm:p-6 text-center group">
            ...
            <!-- Tambah Kelas -->
            <a href="{{ route('admin.classes.create') }}" class="bg-white rounded-lg shadow-sm hover:shadow-md transition p-4 sm:p-6 text-center group">
            ...
            <a href="{{ route('admin.subjects.create') }}" class="bg-white rounded-lg shadow-sm hover:shadow-md transition p-4 sm:p-6 text-center group">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-3 sm:px-6 py-3 sm:py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs sm:text-sm text-gray-900">{{ $log->user->name }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600 hidden md:table-cell">{{ Str::limit($log->description, 50) }}</td>
