...
@section('content')
    <div style="margin-bottom: 30px;">
        ...
        <p class="page-description">Pilih kelas untuk membuat tugas</p>
    </div>
            ...
            @foreach($classes as $class)
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('guru.assignments.create', ['class_id' => $class->id]) }}" class="btn btn-primary" style="width: 100%; justify-content: center;">
