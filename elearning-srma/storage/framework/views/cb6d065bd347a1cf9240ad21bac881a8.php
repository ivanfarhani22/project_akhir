            ...
            <div class="group bg-white rounded-2xl border-2 border-gray-100 hover:border-amber-400 hover:shadow-lg transition-all duration-200 overflow-hidden flex flex-col">
                ...
                <div class="p-5 flex flex-col flex-1">
                    <div class="flex justify-between items-start gap-3 mb-3">
                        <div class="min-w-0">
                            <h3 class="text-sm font-bold text-gray-900 line-clamp-2"><?php echo e($assignment->title); ?></h3>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($assignment->classSubject?->subject?->name ?? '-'); ?></p>
                        </div>
                        <span class="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full border whitespace-nowrap flex-shrink-0 <?php echo e($badgeClass); ?>">
                    ...
                    <?php if($assignment->description): ?>
                        <p class="text-xs text-gray-500 line-clamp-2 mb-3"><?php echo e($assignment->description); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 py-3 border-t border-b border-gray-100 my-3">
                        <div>
                            ...
                            <?php if($deadline): ?>
                                <p class="text-xs font-bold text-gray-800"><?php echo e($deadline->format('d M Y')); ?></p>
                                <p class="text-xs text-amber-500"><?php echo e($deadline->format('H:i')); ?></p>
                            <?php else: ?>
                        ...
                        <div>
                            ...
                            <?php if($submittedAt): ?>
                                <p class="text-xs font-bold text-emerald-600"><?php echo e($submittedAt->format('d M Y')); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e($submittedAt->format('H:i')); ?></p>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/siswa/assignments/index.blade.php ENDPATH**/ ?>