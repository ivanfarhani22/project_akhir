...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    ...
    <a href="<?php echo e(route('guru.assignments.create', ['class_id' => $class->id])); ?>"
                    ...
                    <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-5 py-3.5">
                                <p class="font-semibold text-gray-900"><?php echo e(Str::limit($assignment->title, 40)); ?></p>
                                <?php if($assignment->file_path): ?><p class="text-xs text-gray-400 mt-0.5"><i class="fas fa-paperclip mr-1"></i>File tersedia</p><?php endif; ?>
                            </td>
                            <td class="px-5 py-3.5">
                                <p class="font-semibold text-gray-800 text-xs"><?php echo e($assignment->deadline->format('d M Y')); ?></p>
                                <span class="inline-block mt-1 text-xs font-semibold px-2 py-0.5 rounded-full
                                    <?php echo e($assignment->deadline->isPast() ? 'bg-red-50 text-red-600 border border-red-200' : ($assignment->deadline->diffInDays() <= 2 ? 'bg-yellow-50 text-yellow-700 border border-yellow-200' : 'bg-blue-50 text-blue-600 border border-blue-200')); ?>">
                                    <?php echo e($assignment->deadline->isPast() ? 'Lewat' : ($assignment->deadline->diffInDays() <= 2 ? 'Segera' : 'Aktif')); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3.5 text-center">
                                <p class="text-xl font-extrabold text-blue-600"><?php echo e($submitted); ?></p>
                                <p class="text-xs text-gray-400">dari <?php echo e($total); ?></p>
                            </td>
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-2">
                                    <div class="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                        <div class="h-full bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full" style="width:<?php echo e($pct); ?>%"></div>
                                    </div>
                                    <span class="text-xs text-gray-500 font-medium min-w-max"><?php echo e($pct); ?>%</span>
                                </div>
                            </td>
                            <td class="px-5 py-3.5">
                                <div class="flex justify-center gap-2">
                                    <a href="<?php echo e(route('guru.assignments.show', $assignment)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/guru/assignments/index.blade.php ENDPATH**/ ?>