...
<div class="page-wrap">
    ...
    <aside id="sidebar">
        ...
        <nav class="sb-body">
            ...
            <a href="<?php echo e(route('siswa.dashboard')); ?>" class="sb-link <?php if(request()->routeIs('siswa.dashboard')): ?> active <?php endif; ?>">
            ...
            <a href="<?php echo e(route('siswa.subjects.index')); ?>" class="sb-link <?php if(request()->routeIs('siswa.subjects.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('siswa.schedule.index')); ?>" class="sb-link <?php if(request()->routeIs('siswa.schedule.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('siswa.assignments.index')); ?>" class="sb-link <?php if(request()->routeIs('siswa.assignments.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('siswa.quizzes.index')); ?>" class="sb-link <?php if(request()->routeIs('siswa.quizzes.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
