    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white rounded-2xl border-2 border-gray-100 hover:border-[#A41E35] hover:shadow-lg transition-all duration-200 overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="text-base font-bold text-gray-900 truncate"><?php echo e($class->name); ?></h3>
                    <p class="text-xs text-gray-500 mt-0.5"><i class="fas fa-book-open mr-1"></i><?php echo e($class->subject->name); ?></p>
                    <p class="text-xs text-gray-400 mb-5 mt-0.5"><i class="fas fa-users mr-1"></i><?php echo e($class->students->count()); ?> siswa</p>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/guru/assignments/create-select-class.blade.php ENDPATH**/ ?>