    ...
    <aside id="sidebar">
        ...
        <nav class="sb-body">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.dashboard')): ?> active <?php endif; ?>">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.users.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.classes.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.classes.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.subjects.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.subjects.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.materials.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.materials.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.assignments.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.assignments.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.grades.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.grades.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.attendance.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.attendance.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.storage.index')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.storage.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.settings.edit')); ?>"
               class="sb-link <?php if(request()->routeIs('admin.settings.*')): ?> active <?php endif; ?>">
                <svg class="sb-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="topbar-right">
                ...
                <button type="button" class="user-chip" id="profile-toggle">
                    ...
                    <div>
                        ...
                        <div class="uc-role"><?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->role))); ?></div>
                    </div>
                </button>
                ...
                <div id="profile-card">
                        ...
                        <div class="profile-role">
                            <?php switch(auth()->user()->role):
                                case ('admin_elearning'): ?>
                                    <i class="fas fa-crown"></i> Admin E-Learning <?php break; ?>
                                <?php case ('guru'): ?>
                                    <i class="fas fa-chalkboard-user"></i> Guru <?php break; ?>
                                <?php case ('siswa'): ?>
                                    <i class="fas fa-book"></i> Siswa <?php break; ?>
                            <?php endswitch; ?>
                        </div>
                    </div>
                    ...
                    <div class="profile-footer">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="profile-btn">
                            <i class="fas fa-home"></i> Dashboard
                        </a>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" id="logout-form-profile" style="display:none;"><?php echo csrf_field(); ?></form>
                        <button type="button"
...
</html><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/layouts/admin.blade.php ENDPATH**/ ?>