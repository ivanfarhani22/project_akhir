...
<?php $__env->startSection('icon', 'fas fa-home'); ?>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="h-1 <?php echo e($s['border']); ?>"></div>
            <div class="p-5 flex justify-between items-start">
                ...
                <div class="w-10 h-10 <?php echo e($s['bg']); ?> rounded-xl flex items-center justify-center flex-shrink-0">
                    <i class="fas <?php echo e($s['icon']); ?> <?php echo e($s['color']); ?>"></i>
                </div>
            </div>
        </div>
            ...
            <?php if($upcomingTasks->count() > 0): ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $upcomingTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $sub = \App\Models\Submission::where('student_id',auth()->id())->where('assignment_id',$task->id)->first(); ?>
                        <div class="flex justify-between items-start gap-4 py-3 border-b border-gray-100 last:border-b-0">
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 text-sm truncate"><?php echo e($task->title); ?></p>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($task->eClass->subject->name); ?></p>
                                <p class="text-xs text-amber-500 font-semibold mt-1"><i class="fas fa-calendar-alt mr-1"></i><?php echo e($task->deadline->format('d M, H:i')); ?></p>
                            </div>
                            <span class="inline-flex items-center text-xs font-semibold px-2.5 py-1 rounded-full border whitespace-nowrap flex-shrink-0 <?php echo e($sub && $sub->submitted_at ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-red-50 text-red-600 border-red-200'); ?>">
                                <?php echo e($sub && $sub->submitted_at ? 'Terkumpul' : 'Belum'); ?>
                ...
                <div class="mt-4 text-center">
                    <a href="<?php echo e(route('siswa.assignments.index')); ?>" class="text-xs font-semibold text-blue-500 hover:text-blue-700 transition">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $todaySchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between items-start gap-3 py-2.5 border-b border-gray-100 last:border-b-0">
                                <div>
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($schedule->subject->name); ?></p>
                                    <p class="text-xs text-gray-400 mt-0.5"><?php echo e($schedule->teacher->name); ?></p>
                                </div>
                                <span class="inline-flex items-center text-xs font-bold bg-blue-50 text-blue-600 border border-blue-200 px-2.5 py-1 rounded-lg whitespace-nowrap">
                                    <?php echo e($schedule->start_time ?? 'TBA'); ?>
                ...
                <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($l['href']); ?>"
                       class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition group">
                        <div class="w-9 h-9 <?php echo e($l['bg']); ?> rounded-lg flex items-center justify-center flex-shrink-0">
                            <i class="fas <?php echo e($l['icon']); ?> <?php echo e($l['color']); ?> text-sm"></i>
                        </div>
                        <div>
                            <p class="text-sm font-bold text-gray-900"><?php echo e($l['label']); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($l['desc']); ?></p>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>