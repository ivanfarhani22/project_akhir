...
<?php $__env->startSection('icon', 'cog'); ?>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('school_name', $themeSettings['school_name'])); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('academic_year', $themeSettings['academic_year'])); ?>" 
                            min="2000" 
                            max="2100"
                            required>
                    ...
                    <div class="form-item">
                        ...
                        <select 
                            id="semester"
                            name="semester" 
                            class="form-select <?php $__errorArgs = ['semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            required>
                            <option value="1" <?php echo e(old('semester', $themeSettings['semester']) == '1' ? 'selected' : ''); ?>>Semester 1 (Ganjil)</option>
                            <option value="2" <?php echo e(old('semester', $themeSettings['semester']) == '2' ? 'selected' : ''); ?>>Semester 2 (Genap)</option>
                        </select>
                    ...
                    <div class="form-item">
                        ...
                        <select 
                            id="font_size"
                            name="font_size" 
                            class="form-select <?php $__errorArgs = ['font_size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            required>
                            <option value="small"  <?php echo e(old('font_size', $themeSettings['font_size']) === 'small'  ? 'selected' : ''); ?>>Kecil (14px)</option>
                            <option value="normal" <?php echo e(old('font_size', $themeSettings['font_size']) === 'normal' ? 'selected' : ''); ?>>Normal (16px)</option>
                            <option value="large"  <?php echo e(old('font_size', $themeSettings['font_size']) === 'large'  ? 'selected' : ''); ?>>Besar (18px)</option>
                        </select>
                ...
                <div class="action-buttons">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-cancel">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <?php if($banners->count() > 0): ?>
                <div class="section-title">Banner Tersimpan (<?php echo e($banners->count()); ?>/5)</div>
                <div class="banner-list">
                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="banner-item <?php echo e(!$banner->is_active ? 'inactive' : ''); ?>">
                            <img src="<?php echo e(asset($banner->image_path)); ?>" alt="Banner <?php echo e($loop->iteration); ?>">
                            <span class="banner-badge <?php echo e($banner->is_active ? 'badge-active' : 'badge-inactive'); ?>">
                                <?php echo e($banner->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                            <div class="banner-actions">
                                <form method="POST" action="<?php echo e(route('admin.banners.delete', $banner->id)); ?>" style="margin: 0;" class="delete-form">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form method="POST" action="<?php echo e(route('admin.banners.toggle', $banner->id)); ?>" style="margin: 0;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <button 
                                        type="submit" 
                                        class="banner-btn btn-toggle <?php echo e($banner->is_active ? 'active' : ''); ?>" 
                                        title="<?php echo e($banner->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>">
                                        <i class="fas fa-<?php echo e($banner->is_active ? 'eye-slash' : 'eye'); ?>"></i>
                                    </button>
                                </form>
                            </div>
                        </div>
            ...
            <?php if($remainingSlots > 0): ?>
                <div class="banner-section">
                    ...
                    <div class="info-box">
                        <strong>Slot tersisa:</strong> <?php echo e($remainingSlots); ?>/5 &nbsp;|&nbsp;
                    ...
                    <div class="upload-area" onclick="document.getElementById('banner-input').click();">
                        ...
                        <div class="upload-hint">JPG, PNG, GIF | Maks. 5MB per file | Sisa <?php echo e($remainingSlots); ?> slot</div>
                    </div>
                </div>
            <?php else: ?>
...
(function() {
    const fontSize = '<?php echo e($themeSettings['font_size']); ?>';
...
function handleBannerUpload(input) {
    const maxSlots = <?php echo e($remainingSlots); ?>;
...
function confirmReset() {
    showConfirmation('Reset semua pengaturan ke nilai default?\nTindakan ini tidak dapat dibatalkan.', 'Konfirmasi Reset', function() {
        ...
        form.method = 'POST';
        form.action = '<?php echo e(route('admin.settings.reset')); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/admin/settings/edit.blade.php ENDPATH**/ ?>