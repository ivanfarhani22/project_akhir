...
<?php $__env->startSection('title', 'Manajemen Penyimpanan'); ?>
<?php $__env->startSection('page-title', 'Manajemen Penyimpanan'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 md:col-span-1">
            ...
            <div class="text-xl font-bold text-gray-900 mt-1"><?php echo e($summary['total']['human']); ?></div>
            <div class="text-xs text-gray-600 mt-1"><?php echo e($summary['total']['files']); ?> file</div>
        </div>

        <?php $__currentLoopData = $summary['by_folder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                <div class="text-xs font-semibold text-gray-500 uppercase"><?php echo e($folder); ?></div>
                <div class="text-lg font-bold text-gray-900 mt-1"><?php echo e($data['human']); ?></div>
                <div class="text-xs text-gray-600 mt-1"><?php echo e($data['files']); ?> file</div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('admin.storage.cleanup')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <select name="folder" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                            <?php $__currentLoopData = ['submissions','materials','assignments','banners']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($f); ?>" <?php if(old('folder','submissions') === $f): echo 'selected'; endif; ?>><?php echo e($f); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" min="1" max="3650" name="days" value="<?php echo e(old('days', 180)); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" min="0" name="keep_latest" value="<?php echo e(old('keep_latest')); ?>"
                    ...
                    <label class="flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" name="dry_run" value="1" <?php if(old('dry_run', true)): echo 'checked'; endif; ?>>
        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between gap-4">
                ...
                <form method="GET" action="<?php echo e(route('admin.storage.index')); ?>" class="flex items-center gap-2">
                    <select name="largest_folder" class="px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        <?php $__currentLoopData = ['submissions','materials','assignments','banners']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($f); ?>" <?php if($largestFolder === $f): echo 'selected'; endif; ?>><?php echo e($f); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <select name="largest_limit" class="px-3 py-2 border border-gray-300 rounded-lg text-sm">
                        <?php $__currentLoopData = [10,20,50,100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($n); ?>" <?php if((int)$largestLimit === $n): echo 'selected'; endif; ?>><?php echo e($n); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <form method="POST" action="<?php echo e(route('admin.storage.delete')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $largestFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-3">
                                        <input type="checkbox" name="paths[]" value="<?php echo e($f['path']); ?>" class="file-check">
                                    </td>
                                    <td class="px-6 py-3">
                                        <div class="font-semibold text-gray-900"><?php echo e($f['path']); ?></div>
                                    </td>
                                    <td class="px-6 py-3 font-semibold text-gray-900"><?php echo e($f['human']); ?></td>
                                    <td class="px-6 py-3 text-gray-700">
                                        <?php if($f['last_modified']): ?>
                                            <?php echo e(\Carbon\Carbon::createFromTimestamp($f['last_modified'])->format('d M Y H:i')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\Project Akhir\elearning-srma\resources\views/admin/storage/index.blade.php ENDPATH**/ ?>