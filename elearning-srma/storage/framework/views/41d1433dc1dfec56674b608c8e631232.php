...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    ...
    <a href="<?php echo e(isset($classSubject) && $classSubject ? route('guru.class-subjects.materials.create', $classSubject) : ($csid ? route('guru.class-subjects.materials.create', $csid) : route('guru.materials.create', request()->only(['class_id','class_subject_id'])))); ?>"
